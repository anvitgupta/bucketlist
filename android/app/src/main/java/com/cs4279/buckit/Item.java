...
public class Item {
    ...
    private String originalCreator;  // The username of the creator of the item, should be the original
    private String postCreator;  // The user ID of the creator of this particular item, different from original if "reposted"
    ...
    public Item(Item i) {
        ...
        this.originalCreator = i.originalCreator;
    ...
    public String getPostCreator() { return postCreator; }
    ...
    @Exclude
    public String getPostCreatorUsername() { return postCreatorUsername; }
    ...
    public void setPostCreatorUsername(String username) {
        this.postCreatorUsername = username;
    }
    ...
    public Map<String, Object> toMap() {
        ...
        result.put("originalCreator", originalCreator);
